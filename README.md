...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 79b084b1-c4ae-4719-85e0-37bf63afca11
```

> `79b084b1-c4ae-4719-85e0-37bf63afca11` is the password of the certificate, you can change it to any password you want.
